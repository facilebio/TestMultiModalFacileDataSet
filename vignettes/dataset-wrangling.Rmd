---
title: "Dataset Wrangling and Assembly"
author: "Steve Lianoglou"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Dataset Wrangling and Assembly}
...
Lastly, we will filter out by dataset genes that have 0 counts through all the
samples. This will create a ragged set over the "featurespace" of these
samples, which we will be forced to handle.

```{r, message=FALSE, warning=FALSE}
y.nuc <- pb_split(pb.nuc, "cond")
y.cell <- pb_split(pb.cells, "cond")
```
...
```{r}
fn.nuc <- assay_list_file_path("snRNAseq")
qs::qsave(y.nuc, fn.nuc)

fn.cell <- assay_list_file_path("scRNAseq")
